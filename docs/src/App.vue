  ...
  .fk-guide--section {
    ...
    > .fk-guide--docs {
      ...
      &::-webkit-scrollbar-track {
        background: #ffffff00; /*스크롤바 뒷 배경 색상*/
      }
    }
    ...
    .fk-guide--content {
      ...
      .fk-guide--tab-section {
        display: flex;
        flex-direction: row;

        height: calc(200px - 30px - 3px);

        border-top: 1px solid white;

        .fk-guide--tab-section--left {
          padding-top: 20px;
          padding-left: 20px;
